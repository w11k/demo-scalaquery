...
class DemoScalaQueryProject(info: ProjectInfo) extends DefaultProject(info) {
  ...
  // Provided
  val slf4jJdk14 = "org.slf4j" % "slf4j-simple" % "1.6.1" % "provided" intransitive
  val h2 = "com.h2database" % "h2" % "1.2.140" % "provided"
  val postgresql = "postgresql" % "postgresql" % "8.4-701.jdbc4" % "provided"
